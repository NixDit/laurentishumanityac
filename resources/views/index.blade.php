...
@section('title','Inicio | Laurentis Humanity AC')
@section('content')
<div role="main" class="main">
    ...
    <section class="our-services d-flex p-relative z-index-1 bg-color-light lazyload" data-bg-src="porto/img/demos/business-consulting-2/bg/bg-1.jpg">
            ...
            <div class="row justify-content-end py-5">
                ...
                <div class="col-lg-6 col-coaching-consulting-imgs p-relative">
                    <div class="card border-radius-0 box-shadow-1 border-0 p-3 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="300">
                        <img src="{{ asset('porto/img/demos/business-consulting-2/coaching/coaching-1.jpg') }}" class="img-fluid border-radius-0" alt="">
                    </div>
                    <div class="card border-radius-0 box-shadow-1 border-0 p-3 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="300">
                        <img src="{{ asset('porto/img/demos/business-consulting-2/coaching/coaching-2.jpg') }}" class="img-fluid border-radius-0" alt="">
                    </div>
                    <div class="card border-radius-0 box-shadow-1 border-0 p-3 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="300">
                        <img src="{{ asset('porto/img/demos/business-consulting-2/coaching/coaching-3.jpg') }}" class="img-fluid border-radius-0" alt="">
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="card border-0 border-radius-0 box-shadow-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">
                                    <div class="card-body p-4 z-index-1">
                                        <a href="demo-business-consulting-2-blog-post.html">
                                            <img class="card-img-top border-radius-0" src="{{ asset('porto/img/demos/business-consulting-2/blog/blog-1.png') }}" alt="Card Image">
                                        </a>
                        ...
                        <div class="col-lg-6">
                            <article>
                                <div class="card border-0 border-radius-0 box-shadow-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700">
                                    <div class="card-body p-4 z-index-1">
                                        <a href="demo-business-consulting-2-blog-post.html">
                                            <img class="card-img-top border-radius-0" src="{{ asset('porto/img/demos/business-consulting-2/blog/blog-2.png') }}" alt="Card Image">
                                        </a>
                                        <p class="text-uppercase text-1 mb-3 pt-1 text-color-default"><time pubdate datetime="2023-01-10">10 Jan 2023</time> <span class="opacity-3 d-inline-block px-2">|</span> 3 Comments <span class="opacity-3 d-inline-block px-2">|</span> John Doe</p>
                                        <div class="card-body p-0">
