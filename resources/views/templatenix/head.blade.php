...
<html lang="es">
    ...
    <head>
        ...
        <!-- Demo CSS -->
        <link rel="stylesheet" href="{{ asset('porto/css/demos/demo-business-consulting-2.css') }}">

        <!-- Skin CSS -->
        <link id="skinCSS" rel="stylesheet" href="{{ asset('porto/css/skins/skin-business-consulting-2x.css') }}">
